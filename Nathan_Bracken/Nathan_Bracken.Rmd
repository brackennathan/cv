...
tribble(
  ~Year, ~Type, ~Desc,
  2020, "Economic Forecasting", "Learned how to analyze macroeconomic data and Federal Reserve announcements.",
  ...
  2021, "Linear Algebra I", "Introduced to the fudamentals of matrix algebra including row reduction, determinants, transformations, and subspaces.", 
...
tribble(
  ~Year, ~Name, ~Desc,
  2018, "UO Summit Scholarship", "Awarded for grades in high school and high ACT score.",
  ...
  2021, "Departmental Honors, Economics", "Achieved a 3.6 GPA in upper division economics courses and completed research with the guidance of a professor."
) %>% 
  brief_entries(
    glue::glue("{Name}"),
    Year, 
